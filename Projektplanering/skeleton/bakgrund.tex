...
The sentence ``All adults are human.'' implies that \emph{adults} is a subset of \emph{humans}. Since the property of mortality applies to all humans, it must apply to all adults, hence the conclusion.
